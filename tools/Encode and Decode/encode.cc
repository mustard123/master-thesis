...
int main()
{
    ...
    char test_pkt[] = "\x00\x00\x12\x00\x00\xa1\xbc\x33\x01\x0B\x00\x00\x00\x00\x12\x17\x91\xa0\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x20\x21\x22\x00\x00\x00\xb8\x73";
