...
So we took the code out of the GNU Radio and refactored this OOT module into a single c++ file that can be executed without GNU Radio. Is hereafter referred as encoder.
...
\\
The encoder encodes up and down chirps. Up chirps for preamble, down chirps for start of frame delimiter and both up -and down chirps to encode the data.
...
\section{Improving the Encoder and Chirp Visualization}
