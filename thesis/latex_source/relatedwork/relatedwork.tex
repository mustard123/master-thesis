...
In a Cloud / Centralized RAN (CRAN) the BBU in each tower site are move into a centralized place, the BBU hotel, see Figure~\ref{fig:CRAN}.
...
\begin{figure}[h]
    ...
    \caption{Distributed cell towers each with a RRH and BBU~\cite{fujitsu}}
    \label{fig:CRAN}
\end{figure}

\section{RAN as a service}